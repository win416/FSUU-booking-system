            ...
            <div class="container-fluid my-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 no-print">
                    ...
                    <div class="d-flex gap-2 flex-wrap align-items-center">
                        <input type="date" id="start_date" class="form-control" style="width:160px" value="<?php echo date('Y-m-d', strtotime('-30 days')); ?>">
                        <input type="date" id="end_date" class="form-control" style="width:160px" value="<?php echo date('Y-m-d'); ?>">
